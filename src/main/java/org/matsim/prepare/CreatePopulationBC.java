...
public class CreatePopulationBC {

	private static final Logger log = Logger.getLogger(CreatePopulationBC.class);
	...
	public static void main(String[] args) throws IOException {
		...
		final String outputFilePopulation = "./scenarios/measures/input/serengeti-park-population-BC.xml.gz";

		Config config = ConfigUtils.createConfig();
		config.network().setInputFile(networkFile);
		Scenario scenario = ScenarioUtils.loadScenario(config);

		CreatePopulationBC popGenerator = new CreatePopulationBC(1000, 675, 1569, 7200);
	...
	public CreatePopulationBC(int numberOfSafariVisitors, int safariParkplatzVisitors, int wasserlandParkplatzVisitors, int timeSlotDuration) throws IOException {
