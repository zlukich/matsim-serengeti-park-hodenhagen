 ...
 *
 */
public class CreatePopulationEndActivityAdapted {

	private static final Logger log = Logger.getLogger(CreatePopulationEndActivityAdapted.class);
	...
	public static void main(String [] args) throws IOException, ParseException {
		...
		CreatePopulationEndActivityAdapted popGenerator = new CreatePopulationEndActivityAdapted(1000, 675, 1569);
	...
	public CreatePopulationEndActivityAdapted(int numberOfSafariVisitors, int safariParkplatzVisitors, int wasserlandParkplatzVisitors) throws IOException {
	...
	public Scenario run(Scenario scenario) {
		...
		for (Id<Link> linkId : linkId2numberOfVisitorsSerengetiPark.keySet()) {
			createSafariVisitors(scenario, rnd, linkId, linkId2numberOfVisitorsSerengetiPark.get(linkId), this.serengetiParkDestination);
		}
...
//			double startTime = calculateNormallyDistributedTime(11 * 3600., 1 * 3600.); // normally distributed
	...
	private void createSafariVisitors(Scenario scenario, Random rnd, Id<Link> linkId, double odSum, String type) {
		Population population = scenario.getPopulation();
		PopulationFactory popFactory = population.getFactory();
