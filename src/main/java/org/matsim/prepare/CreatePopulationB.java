...
public class CreatePopulationB {

	private static final Logger log = Logger.getLogger(CreatePopulationB.class);
	...
	public static void main(String[] args) throws IOException {
		...
		final String networkFile = "./scenarios/measures/input/serengeti-park-network-v1.0.xml.gz";
		final String outputFilePopulation = "./scenarios/measures/input/serengeti-park-population-B.xml.gz";

		Config config = ConfigUtils.createConfig();
		config.network().setInputFile(networkFile);
		Scenario scenario = ScenarioUtils.loadScenario(config);

		CreatePopulationB popGenerator = new CreatePopulationB(1000, 675, 1569, 7200);
	...
	public CreatePopulationB(int numberOfSafariVisitors, int safariParkplatzVisitors, int wasserlandParkplatzVisitors, int timeSlotDuration) throws IOException {
