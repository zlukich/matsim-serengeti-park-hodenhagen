...
public class NetworkAddCToA {

    private static final String INPUT_NETWORK = "./scenarios/input/serengeti-park-network-A.xml.gz";
    private static final String OUTPUT_NETWORK = "./scenarios/input/serengeti-park-network-AC.xml.gz";
