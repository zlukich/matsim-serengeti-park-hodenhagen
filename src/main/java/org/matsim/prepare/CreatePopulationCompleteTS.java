...
public class CreatePopulationCompleteTS {

	private static final Logger log = Logger.getLogger(CreatePopulationCompleteTS.class);
	...
	public static void main(String[] args) throws IOException {
		...
		CreatePopulationCompleteTS popGenerator = new CreatePopulationCompleteTS(1000, 675, 1569, 543, 7200, 10., 18.);
	...
	public CreatePopulationCompleteTS(int numberOfSafariVisitors, int safariParkplatzVisitors, int wasserlandParkplatzVisitors, int eickelohParkplatzVisitors, int timeSlotDuration, double openingTime, double closingTime) throws IOException {
	...
	public Scenario runB(Scenario scenario) {
		...
		for (int i=0; i<numberOfTimeSlots; i++) {
			...
			for (Id<Link> linkId : partOfLinkId2numberOfVisitorsWasserlandParkplatz.keySet()) {
				createVisitorsB(scenario, rnd, linkId, partOfLinkId2numberOfVisitorsWasserlandParkplatz.get(linkId), this.wasserlandParkplatzDestination, i+1);
			}
...
//			double startTime = calculateNormallyDistributedTime(11 * 3600., 1 * 3600.); // normally distributed
	...
	private double sharePerTS(int i){
		return -0.0549*i*i + 0.1768*i + 0.1768;
	}
