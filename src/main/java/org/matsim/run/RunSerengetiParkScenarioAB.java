...
import org.matsim.prepare.CreatePopulationAB;
...
public final class RunSerengetiParkScenarioAB {

	private static final Logger log = Logger.getLogger(RunSerengetiParkScenarioAB.class );
...
//		controler.addOverridingModule( new OTFVisLiveModule() ) ;
	...
	public static Scenario prepareScenario( Config config ) throws IOException {
		...
		CreatePopulationAB createPopulation = new CreatePopulationAB(serengetiParkVehicles, serengetiCarparkVehicles, wasserlandCarparkVehicles, eickelohCarparkVehicles, timeSlotDuration);
...
//		config.controler().setRoutingAlgorithmType( FastAStarLandmarks );
		...
		//ms:
		config.controler().setOutputDirectory("./scenarios/measures/output/serengeti-park-AB/output-serengeti-park-AB-run20visitors");
