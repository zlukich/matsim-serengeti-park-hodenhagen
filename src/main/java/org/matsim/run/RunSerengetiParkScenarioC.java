...
public final class RunSerengetiParkScenarioC {

	private static final Logger log = Logger.getLogger(RunSerengetiParkScenarioC.class );
...
//		controler.addOverridingModule( new OTFVisLiveModule() ) ;
	...
	public static Scenario prepareScenario( Config config ) throws IOException {
		...
		CreatePopulationC createPopulation = new CreatePopulationC(serengetiParkVehicles, serengetiCarparkVehicles, wasserlandCarparkVehicles);
...
//		config.controler().setRoutingAlgorithmType( FastAStarLandmarks );
		...
		//ms:
		config.controler().setOutputDirectory("./scenarios/measures/output/serengeti-park-C/output-serengeti-park-C-run100visitors");
