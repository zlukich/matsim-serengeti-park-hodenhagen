...
public final class RunSerengetiParkScenarioBC {

	private static final Logger log = Logger.getLogger(RunSerengetiParkScenarioBC.class );
...
//		controler.addOverridingModule( new OTFVisLiveModule() ) ;
	...
	public static Scenario prepareScenario( Config config ) throws IOException {
		...
		CreatePopulationBC createPopulation = new CreatePopulationBC(serengetiParkVehicles, serengetiCarparkVehicles, wasserlandCarparkVehicles, timeSlotDuration);
...
//		config.controler().setRoutingAlgorithmType( FastAStarLandmarks );
		...
		// ms: set networkInput
		config.network().setInputFile("serengeti-park-network-C.xml.gz");
		...
		// ms:
		config.controler().setOutputDirectory("./scenarios/measures/output/serengeti-park-BC/output-serengeti-park-BC-run100visitors");
