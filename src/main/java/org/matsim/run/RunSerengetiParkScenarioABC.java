...
import org.matsim.prepare.CreatePopulationBC;
...
public final class RunSerengetiParkScenarioABC {

	private static final Logger log = Logger.getLogger(RunSerengetiParkScenarioABC.class );
...
//		controler.addOverridingModule( new OTFVisLiveModule() ) ;
	...
	public static Scenario prepareScenario( Config config ) throws IOException {
		...
		CreatePopulationABC createPopulation = new CreatePopulationABC(serengetiParkVehicles, serengetiCarparkVehicles, wasserlandCarparkVehicles, eickelohCarparkVehicles, timeSlotDuration);
...
//		config.controler().setRoutingAlgorithmType( FastAStarLandmarks );
		...
		// ms:
		config.controler().setOutputDirectory("./scenarios/measures/output/serengeti-park-ABC/output-serengeti-park-ABC-run100visitors");
